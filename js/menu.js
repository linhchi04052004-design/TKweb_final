document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- 1. CẤU HÌNH ẢNH CỦA BẠN TẠI ĐÂY ---
    // Hãy dán link ảnh thiết kế của bạn vào đây (theo thứ tự hiển thị)
    // Lưu ý: Số lượng ảnh gốc nên là số CHẴN (ví dụ: 4, 6, 8, 10 ảnh)
    const DANH_SACH_ANH = [
    ...
    const pageWidth = Math.floor(screenWidth * 0.40); 
